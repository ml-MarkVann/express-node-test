...
exports.book_detail = function(req, res, next) {
  async.parallel({
    ...
    if (err) { return next(err); }
    //Successful, so render
    res.render('book_detail', { title: 'Book:', book: results.book, book_instances: results.book_instances } );
  });
};
...
exports.book_delete_post = function(req, res, next) {
  ...
  async.parallel({
    ...
    if (results.book_instances>0) {
      res.render('book_delete', { title: 'Delete Book', author: results.author, book_instances: results.book_instances } );
      return;
    }
    else {
